...
Defines conventions for using SVG icons in the zeno-house project via `nuxt-svgo` — placement, naming, component usage, sizing, color theming, and anti-patterns.
