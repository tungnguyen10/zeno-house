...
- [x] 3.5 Add an "Xuat Excel" action on the operations report page gated by `operations-report.export`
...
- [x] 5.1 Add a "Chi phi van hanh" section to `/buildings/[id]/settings` with fixed-cost create/end/history gated by `building-fixed-costs.write`
