...
Any database schema or data migration required by this change SHALL be explicitly documented and prepared as SQL for manual execution in Supabase Dashboard SQL Editor. The implementation SHALL NOT assume automatic database application through `supabase db push`.
