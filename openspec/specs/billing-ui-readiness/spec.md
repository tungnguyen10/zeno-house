...
- **WHEN** the user performs a destructive billing action (void invoice, reissue invoice, unissue period, save meter override, create negative adjustment with absolute value >= 100000 VND)
