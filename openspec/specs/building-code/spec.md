## Purpose
Defines the short alphanumeric code assigned to each building, used as a human-readable URL identifier and as a prefix in room codes and contract codes.
