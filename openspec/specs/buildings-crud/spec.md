...
Full CRUD management for buildings. Admins see and manage all buildings; managers see only buildings where they are `manager_id` (enforced via RLS). Routes live under `/admin/buildings` and `/manager/buildings`.
