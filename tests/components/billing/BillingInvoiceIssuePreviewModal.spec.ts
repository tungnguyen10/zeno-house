...
function preview(): BillingInvoiceIssuePreview {
  return {
    ...
    items: [{
      ...
      issuedAt: '2026-08-05T00:00:00.000Z', dueDate: '2026-08-09', totalAmount: 3_200_000,
...
describe('BillingInvoiceIssuePreviewModal', () => {
  it('shows batch summary and exclusions without exposing a print action', () => {
    const wrapper = mount(BillingInvoiceIssuePreviewModal, {
      props: { open: true, preview: preview(), dueDate: '2026-08-09', loading: false, submitting: false, error: null },
      global: {
        stubs: {
          UiModal: passthrough,
  ...
  it('keeps confirm disabled while stale and offers a refresh', () => {
    const wrapper = mount(BillingInvoiceIssuePreviewModal, {
      props: {
        open: true, preview: preview(), dueDate: '2026-08-09', loading: false, submitting: false,
