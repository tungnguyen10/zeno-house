...
| POST | `/api/billing/invoices/[id]/email-deliveries/resend` | n/a | invalidate affected domain | p95 ≤ 250ms |
...
| DELETE | `/api/billing/periods/[id]/incidental-charges/[chargeId]` | n/a | invalidate affected domain | p95 ≤ 250ms |
| PATCH | `/api/billing/periods/[id]/incidental-charges/[chargeId]` | n/a | invalidate affected domain | p95 ≤ 250ms |
| GET | `/api/billing/periods/[id]/incidental-charges` | domain-bounded | request/DTO policy | p95 ≤ 400ms |
| POST | `/api/billing/periods/[id]/incidental-charges` | n/a | invalidate affected domain | p95 ≤ 250ms |
...
| GET | `/api/tenant-accounts/orphans` | domain-bounded | request/DTO policy | p95 ≤ 400ms |
...
| POST | `/api/tenant/documents` | n/a | invalidate affected domain | p95 ≤ 250ms |
| DELETE | `/api/tenant/id-images/[side]` | n/a | invalidate affected domain | p95 ≤ 250ms |
| POST | `/api/tenant/id-images/[side]` | n/a | invalidate affected domain | p95 ≤ 250ms |
| GET | `/api/tenant/id-images` | domain-bounded | request/DTO policy | p95 ≤ 400ms |
| GET | `/api/tenant/invoices/[id]` | n/a | request/DTO policy | p95 ≤ 250ms |
