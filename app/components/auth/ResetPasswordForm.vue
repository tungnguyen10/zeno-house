<template>
  <UCard class="w-full max-w-sm">
    <template #header>
      <h1 class="text-xl font-bold text-center text-[--color-title]">{{ $t("auth.reset_password_title") }}</h1>
      <p class="text-sm text-center text-[--color-body] mt-1">{{ $t("auth.reset_password_description") }}</p>
    </template>
