...
export const BILLING_AUDIT_ACTIONS = {
  ...
  UTILITY_OVERRIDE_DELETED: 'utility_override.deleted',
  UTILITY_OVERRIDE_APPROVED: 'utility_override.approved',
  INCIDENTAL_CHARGE_CREATED: 'incidental_charge.created',
  INCIDENTAL_CHARGE_UPDATED: 'incidental_charge.updated',
  INCIDENTAL_CHARGE_DELETED: 'incidental_charge.deleted',
...
export const BILLING_AUDIT_ACTION_CATEGORY: Record<BillingAuditAction, BillingAuditCategory> = {
  ...
  'utility_override.deleted': 'destructive',
  'incidental_charge.created': 'create',
  'incidental_charge.updated': 'edit',
  'incidental_charge.deleted': 'destructive',
  'payment.edited': 'edit',
